...
class Inputs:
    def __init__(self):
        ...
        self.nTimeStep = 0.002#0.001 # Picked to smooth the mapping between stellar masses and lifetimes
        ...
        self.SFR_rescaling = 0.02 # !!!!!!! Constrained by observations at z=0 of the galaxy of interest
